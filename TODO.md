...
### 2. Ускорение сборки
- [ ] Сборка ~10.1s → <10s (цель достигнута, но нестабильно)
- [ ] Исследовать: кэширование TypeScript
- [ ] Исследовать: параллельная обработка
...
2. **Ускорение сборки** — 10.1s → <10s (стабильно)
