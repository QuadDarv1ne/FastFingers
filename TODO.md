...
- [ ] Оптимизация pdf-vendor чанка (624 KB → <300 KB)
...
9. **pdf-vendor** — 624 KB, требуется оптимизация (tree-shaking, lazy-import)
...
- **Следующий шаг**: оптимизация pdf-vendor, integration тесты, контент (40 текстов осталось)
...
21. **Сборка** — успешна, ~17s, bundle <250KB gzipped, PWA 34 entries
...
1. Вынести тексты упражнений в texts.json с категориями — добавлено 10 текстов ✅
2. Добавить 50+ новых текстов (фильмы, новости, философия, бизнес) — 10/50 ✅
...
1. pdf-vendor чанк: 624 KB → <300 KB (tree-shaking, lazy-import jspdf)
