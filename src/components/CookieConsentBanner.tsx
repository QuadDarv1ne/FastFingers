          ...
          <div className="max-w-4xl mx-auto bg-dark-800/95 backdrop-blur-sm border border-dark-600 rounded-2xl p-6 shadow-2xl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-white font-semibold mb-1">{t('cookie.title')}</h3>
                <p className="text-dark-400 text-sm">
                  {t('cookie.description')}
                  {' '}<a href="/cookie-policy.md" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 underline">{t('cookie.policyLink')}</a>{' '}{t('cookie.and')}{' '}<a href="/privacy-policy.md" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 underline">{t('cookie.privacyLink')}</a>.
                </p>
              </div>
