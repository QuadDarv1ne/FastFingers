...
export function OnlineStatus() {
  ...
  return (
    <div className="online-status" role="alert" aria-live="assertive">
      <div className="online-status__content">
        <svg className="online-status__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
