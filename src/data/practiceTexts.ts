...
export const practiceTexts: PracticeText[] = [
  ...
  // === НОВОСТИ (дополнительно) ===
  {
    id: 'news-6',
    category: 'news',
    difficulty: 4,
    title: 'Образование',
    text: 'Онлайн-образование становится всё более популярным среди студентов по всему миру.',
  },
  {
    id: 'news-7',
    category: 'news',
    ...
    text: 'Новые медицинские технологии позволяют диагностировать заболевания на ранних стадиях.',
  },
  {
    id: 'news-8',
    category: 'news',
    difficulty: 6,
    title: 'Энергетика',
    text: 'Атомная энергетика переживает ренессанс благодаря новым безопасным реакторам.',
  },
  {
    id: 'news-9',
    category: 'news',
    difficulty: 7,
    title: 'Транспорт',
    text: 'Гиперлуп — новая транспортная система, способная развивать скорость до 1200 км/ч.',
  },
  {
    id: 'news-10',
    category: 'news',
    difficulty: 8,
    title: 'Искусственный интеллект',
    text: 'Нейронные сети научились генерировать фотореалистичные изображения по текстовому описанию.',
  },
