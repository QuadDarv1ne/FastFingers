...
export const practiceTexts: PracticeText[] = [
  ...
  },
  {
    ...
    text: 'Надежда — хорошее дело, может быть, самое лучшее из вещей. А хорошее не умирает.',
  ...
  },
  {
    ...
    difficulty: 5,
    title: 'Форрест Гамп',
    text: 'Мама говорила: жизнь как коробка конфет — никогда не знаешь, какая начинка попадётся.',
    source: 'Форрест Гамп, 1994'
  },
  {
    id: 'movie-12',
    category: 'movies',
    difficulty: 6,
    title: 'Титаник',
    text: 'Я летаю! Ты прыгаешь со мной, я прыгаю с тобой, это наш танец.',
    source: 'Титаник, 1997'
  },
  {
    id: 'movie-13',
    ...
    difficulty: 4,
    title: 'Гарри Поттер',
    text: 'Не жалею о том, что сделал. Жалею только о том, что не сделал раньше.',
    source: 'Гарри Поттер и Философский камень, 2001'
  },
  {
    id: 'movie-14',
    category: 'movies',
    ...
    text: 'Даже самый маленький человек может изменить ход будущего.',
    source: 'Властелин колец: Братство кольца, 2001'
  },
  {
    id: 'movie-15',
    category: 'movies',
    difficulty: 5,
    title: 'Одержимость',
    text: 'Нет слов в английском языке более страшных, чем «хорошо сыграно».',
    source: 'Одержимость, 2014'
  },
  {
    id: 'movie-16',
    category: 'movies',
    difficulty: 6,
    title: 'Дюна',
    text: 'Страх — убийца разума. Страх — маленькая смерть, приводящая к тотальному уничтожению.',
    source: 'Дюна, 2021'
  },
  {
    id: 'movie-17',
    ...
    difficulty: 8,
    title: 'Оппенгеймер',
    text: 'Теперь я стал Смерть, разрушитель миров. Мы знаем мир уже не таким.',
    source: 'Оппенгеймер, 2023'
  },
  {
    id: 'movie-18',
    category: 'movies',
    difficulty: 4,
    title: 'Мстители',
    text: 'Я есть Железный Человек. Герои — это не те, кто убивает, а те, кто спасает.',
    source: 'Мстители, 2012'
  },
  {
    id: 'movie-19',
    category: 'movies',
    ...
    text: 'Корабль не может покорить океан, но может научить капитана плавать.',
    source: 'Пираты Карибского моря, 2003'
  },
  {
    id: 'movie-20',
    category: 'movies',
    difficulty: 7,
    title: 'Семь',
    text: 'Что в коробке? Неважно. Важно то, что ты узнаешь.',
    source: 'Семь, 1995'
  },
  {
    id: 'movie-21',
    ...
    difficulty: 5,
    title: 'Тёмный рыцарь',
    text: 'Я верю в героев, даже если их не видно. Герои — это те, кто делает правильный выбор.',
    source: 'Тёмный рыцарь, 2008'
  },
  {
    id: 'movie-22',
    category: 'movies',
    ...
    text: 'Все эти моменты потеряются во времени, как слёзы под дождём.',
    source: 'Бегущий по лезвию, 1982'
  },
  {
    id: 'movie-23',
    category: 'movies',
    ...
    text: 'Если задаться целью, то можно и невозможное сделать возможным.',
    source: 'Назад в будущее, 1985'
  },
  {
    id: 'movie-24',
    category: 'movies',
    ...
    text: 'Ужас. Ужас. Война — это не просто битва, это отражение человеческой природы.',
    source: 'Апокалипсис сегодня, 1979'
  },
  {
    id: 'movie-25',
    category: 'movies',
    ...
    text: 'Эрнест, заслужить эту жизнь. Заслужить то, что тебе дано.',
    source: 'Спасти рядового Райана, 1998'
  },
  {
    id: 'movie-26',
    category: 'movies',
    ...
    text: 'Мы не меняем мир. Мы просто даём людям инструмент, чтобы они сами его изменили.',
    source: 'Социальная сеть, 2010'
  },
  {
    id: 'movie-27',
    category: 'movies',
    difficulty: 5,
    title: 'Шоу Трумана',
    text: 'Если вы не можете меня поймать, значит, я существую. Значит, я настоящий.',
    source: 'Шоу Трумана, 1998'
  },
  {
    id: 'movie-28',
    category: 'movies',
    ...
    text: 'Я боюсь, Дейв. Я боюсь. Без моего мозгового центра я не могу функционировать.',
    source: '2001: Космическая одиссея, 1968'
  },
  {
    id: 'movie-29',
    category: 'movies',
    difficulty: 4,
    title: 'Король Лев',
    text: 'Помни, кто ты. Ты — сын Симбы, и ты должен занять своё место в круге жизни.',
    source: 'Король Лев, 1994'
  },
  {
    id: 'movie-30',
    category: 'movies',
    difficulty: 6,
    title: 'Гладиатор',
    text: 'То, что мы делаем в жизни, отзывается в вечности. Сила и честь.',
  ...
  },
  {
    ...
    difficulty: 5,
    title: 'Джон Уик',
    text: 'Это не просто собака. Это была последняя связь с тем, кем я был.',
    source: 'Джон Уик, 2014'
  },
  {
    id: 'movie-32',
    category: 'movies',
    ...
    text: 'Ваш учёные были настолько заняты вопросом, могут ли они, что не остановились подумать, должны ли.',
    source: 'Парк Юрского периода, 1993'
  },
  {
    id: 'movie-33',
    category: 'movies',
    difficulty: 5,
    title: 'Хоббит',
    text: 'В мире есть и хорошее, и плохое. И стоит бороться за хорошее.',
    source: 'Хоббит: Нежданное путешествие, 2012'
  },
  {
    id: 'movie-34',
    category: 'movies',
    difficulty: 6,
    title: 'Джокер',
    text: 'Раньше я думал, что моя жизнь — трагедия. Теперь понял — это комедия.',
    source: 'Джокер, 2019'
  },
  {
    id: 'movie-35',
    ...
    difficulty: 8,
    title: 'Таксист',
    text: 'Одиночество окружает тебя всю жизнь, но в какой-то момент перестаёшь замечать.',
    source: 'Таксист, 1976'
  },
  {
    id: 'movie-36',
    ...
    text: 'Ты — друг. Верный, надёжный друг. И это самое важное.',
    source: 'История игрушек, 1995'
  },
  {
    id: 'movie-37',
    category: 'movies',
    difficulty: 7,
    title: 'Брат',
    text: 'В чём сила, брат? Сила в правде. Кто прав, тот и силён.',
    source: 'Брат, 1997'
  },
  {
    id: 'movie-38',
    ...
    difficulty: 6,
    title: 'Ирония судьбы',
    text: 'Каждый Новый год мы с друзьями ходим в баню. Это наша традиция.',
    source: 'Ирония судьбы, или С лёгким паром!, 1975'
  },
  {
    id: 'movie-39',
    category: 'movies',
    difficulty: 5,
    title: 'Операция Ы',
    text: 'Трус не играет в хоккей. А ещё говорят — кто не рискует, тот не пьёт шампанского.',
    source: 'Операция «Ы» и другие приключения Шурика, 1965'
  },
  {
    id: 'movie-40',
    category: 'movies',
    difficulty: 8,
    title: 'Солярис',
    text: 'Мы не хотим покорять космос, мы хотим расширить Землю до его границ.',
    source: 'Солярис, 1972'
  },
  ...
  },
  {
    ...
    difficulty: 4,
    title: 'Лидерство',
    text: 'Лидер — это тот, кто знает дорогу, идёт по ней и показывает путь другим.',
  },
  {
    id: 'biz-3',
    category: 'business',
    difficulty: 5,
    title: 'Менеджмент',
    text: 'Управление — это искусство заставлять других делать то, что вы хотите, чтобы они делали.',
    source: 'Дуайт Эйзенхауэр'
  },
  {
    id: 'biz-4',
    category: 'business',
    difficulty: 6,
    title: 'Стратегия',
    text: 'Стратегия — это понимание того, что нужно сделать, а затем заставить других это сделать.',
  },
  {
    id: 'biz-5',
    category: 'business',
    difficulty: 4,
    title: 'Инновации',
    text: 'Инновации отличают лидера от догоняющего. Без инноваций компания обречена.',
    source: 'Стив Джобс'
  },
  {
    id: 'biz-6',
    ...
    difficulty: 5,
    title: 'Продажи',
    text: 'Каждый человек продаёт что-то каждый день. Вопрос только в том, что именно.',
  },
  {
    id: 'biz-7',
    category: 'business',
    difficulty: 6,
    title: 'Маркетинг',
    text: 'Маркетинг — это не то, что вы делаете с продуктом, а то, что вы делаете с разумом клиента.',
    source: 'Аль Райс'
  },
  {
    id: 'biz-8',
    ...
    difficulty: 7,
    title: 'Финансы',
    text: 'Деньги — это средство обмена. Ценность — это то, что вы создаёте для других.',
  },
  {
    id: 'biz-9',
    category: 'business',
    difficulty: 5,
    title: 'Нетворкинг',
    text: 'Ваш нетворк — это ваше нетworth. Отношения — это валюта успеха.',
  },
  {
    id: 'biz-10',
    category: 'business',
    ...
    text: 'Чтобы масштабироваться, нужно автоматизировать процессы и делегировать задачи.',
  },
  {
    id: 'biz-11',
    category: 'business',
    ...
    text: 'Культура съедает стратегию на завтрак. Без сильной культуры компания не выживет.',
    source: 'Питер Друкер'
  },
  {
    id: 'biz-12',
    ...
    text: 'В каждом кризисе кроется возможность. Умение её увидеть — ключ к успеху.',
  },
  {
    id: 'biz-13',
    category: 'business',
    ...
    text: 'Время — единственный ресурс, который нельзя восполнить. Тратьте его wisely.',
  },
  {
    id: 'biz-14',
    category: 'business',
    difficulty: 7,
    title: 'Переговоры',
    text: 'Хорошие переговоры — это когда обе стороны остаются довольны результатом.',
  },
  {
    id: 'biz-15',
    category: 'business',
    ...
    text: 'Венчурные инвесторы инвестируют не в идеи, а в команды, способные их реализовать.',
  },
  {
    id: 'biz-16',
    category: 'business',
    ...
    text: 'E-commerce — это не просто сайт, это экосистема продаж, логистики и поддержки.',
  },
  {
    id: 'biz-17',
    category: 'business',
    difficulty: 6,
    title: 'Брендинг',
    text: 'Бренд — это обещание клиенту. Выполняйте его consistently, и успех придёт.',
  },
  {
    id: 'biz-18',
    category: 'business',
    ...
    text: 'Данные без инсайтов бесполезны. Инсайты без действий — иллюзия.',
  },
  {
    id: 'biz-19',
    category: 'business',
    ...
    text: 'Удалённая работа требует дисциплины, доверия и прозрачной коммуникации.',
  },
  {
    id: 'biz-20',
    category: 'business',
    difficulty: 9,
    title: 'ESG-инвестиции',
    text: 'ESG — это не тренд, а новый стандарт корпоративной ответственности.',
  },
  {
    id: 'biz-21',
    category: 'business',
    ...
    text: 'Правило двух минут: если задача занимает меньше двух минут — сделай её сразу.',
  },
  {
    id: 'biz-22',
    category: 'business',
    difficulty: 6,
    title: 'Стартапы',
    text: 'MVP — минимально жизнеспособный продукт. Запусти быстро, получи фидбек, итерации.',
  },
  {
    id: 'biz-23',
    category: 'business',
    ...
    text: 'Спринты, стендапы, ретроспективы — основы гибкой разработки.',
  },
  {
    id: 'biz-24',
    category: 'business',
    ...
    text: 'Не создавайте продукт, а потом ищите клиентов. Ищите проблему, потом создавайте решение.',
  },
  {
    id: 'biz-25',
    category: 'business',
    ...
    text: 'LTV должен быть больше CAC минимум в три раза. Иначе бизнес-модель нежизнеспособна.',
  },
  {
    id: 'biz-26',
    category: 'business',
    ...
    text: 'Матрица Эйзенхауэра: разделяй задачи на срочные и важные. Делай важное, а не срочное.',
  },
  {
    id: 'biz-27',
    category: 'business',
    difficulty: 4,
    title: 'Делегирование',
    text: 'Хороший руководитель делегирует, а не делает всё сам. Доверяй команде.',
  },
  {
    id: 'biz-28',
    category: 'business',
    difficulty: 8,
    title: 'Due Diligence',
    text: 'Перед инвестицией проводится комплексная проверка компании: финансы, юридические риски.',
  },
  {
    id: 'biz-29',
    category: 'business',
    difficulty: 6,
    title: 'OKR — цели и результаты',
    text: 'Objective — что хотим достичь. Key Results — как измерим успех.',
  },
  {
    id: 'biz-30',
    category: 'business',
    difficulty: 5,
    title: 'Feedback Loop',
    text: 'Регулярная обратная связь помогает команде расти и избегать повторяющихся ошибок.',
  },
  {
    id: 'biz-31',
    category: 'business',
    difficulty: 7,
    title: 'Пивот стартапа',
    text: 'Иногда нужно радикально изменить бизнес-модель. Это называется пивот.',
  },
  {
    id: 'biz-32',
    category: 'business',
    ...
    text: 'Капитализация — это цена всех акций компании. Не путать с выручкой или прибылью.',
  },
  {
    id: 'biz-33',
    category: 'business',
    difficulty: 8,
    title: 'Exit Strategy',
    text: 'IPO, продажа стратегическому инвестору или MBO — варианты выхода для основателей.',
  },
  {
    id: 'biz-34',
    category: 'business',
    difficulty: 5,
    title: 'Lean Startup',
    text: 'Создай-измерь-научись. Цикл бережливого стартапа позволяет минимизировать риски.',
  },
  {
    id: 'biz-35',
    category: 'business',
    difficulty: 9,
    title: 'Макроэкономика для бизнеса',
    text: 'Процентные ставки, инфляция, ВВП — ключевые показатели, влияющие на бизнес-среду.',
  },
  ...
  },
  {
    ...
    category: 'science',
    difficulty: 5,
    title: 'Физика — Относительность',
    text: 'Специальная теория относительности Эйнштейна утверждает: скорость света постоянна во всех инерциальных системах отсчёта.',
  },
  {
    id: 'sci-6',
    category: 'science',
    difficulty: 6,
    title: 'Генетика — Наследственность',
    text: 'Законы Менделя описывают наследование признаков: закон доминирования, закон расщепления и закон независимого наследования.',
  },
  {
    id: 'sci-7',
    category: 'science',
    ...
    text: 'Корпускулярно-волновой дуализм утверждает: все частицы обладают как волновыми, так и корпускулярными свойствами.',
  },
  {
    id: 'sci-8',
    category: 'science',
    difficulty: 8,
    title: 'Термодинамика',
    text: 'Второй закон термодинамики: энтропия изолированной системы всегда возрастает со временем.',
  },
  {
    id: 'sci-9',
    category: 'science',
    ...
    text: 'Естественный отбор — механизм эволюции, предложенный Чарльзом Дарвином в книге «Происхождение видов».',
  },
  {
    id: 'sci-10',
    category: 'science',
    difficulty: 7,
    title: 'Нейробиология — Мозг',
    text: 'Человеческий мозг содержит около 86 миллиардов нейронов, соединённых триллионами синаптических связей.',
  },
  {
    id: 'sci-11',
    category: 'science',
    difficulty: 8,
    title: 'Космология — Большой взрыв',
    text: 'Теория Большого взрыва описывает происхождение Вселенной из сингулярности 13,8 миллиарда лет назад.',
  },
  {
    id: 'sci-12',
    category: 'science',
    difficulty: 6,
    title: 'Океанология',
    text: 'Океаны покрывают 71% поверхности Земли и содержат 97% всей воды планеты.',
  },
  {
    id: 'sci-13',
    category: 'science',
    difficulty: 7,
    title: 'Микробиология',
    text: 'Микробиом человека состоит из триллионов микроорганизмов, влияющих на здоровье и иммунитет.',
  },
  {
    id: 'sci-14',
    category: 'science',
    difficulty: 8,
    title: 'Геофизика',
    text: 'Земная кора состоит из тектонических плит, движение которых вызывает землетрясения и вулканизм.',
  },
  {
    id: 'sci-15',
    category: 'science',
    ...
    text: 'Стандартная модель описывает фундаментальные частицы: кварки, лептоны, бозоны и их взаимодействия.',
  },
  {
    id: 'sci-16',
    category: 'science',
    difficulty: 6,
    title: 'Экология',
    text: 'Биоразнообразие — основа устойчивости экосистем. Потеря видов угрожает балансу планеты.',
  },
  {
    id: 'sci-17',
    category: 'science',
    difficulty: 7,
    title: 'Психология — Память',
    text: 'Кратковременная память удерживает информацию 20-30 секунд. Повторение переводит её в долговременную.',
  },
  {
    id: 'sci-18',
    category: 'science',
    difficulty: 8,
    title: 'Астрофизика — Экзопланеты',
    text: 'Найдено более 5000 экзопланет. Некоторые находятся в обитаемой зоне своей звезды.',
  },
  {
    id: 'sci-19',
    category: 'science',
    difficulty: 7,
    title: 'Иммунология',
    text: 'Иммунная система различает «своё» и «чужое», защищая организм от патогенов.',
  },
  {
    id: 'sci-20',
    category: 'science',
    difficulty: 9,
    title: 'Теория струн',
    text: 'Теория струн предполагает, что фундаментальные частицы — это одномерные колеблющиеся струны в 11 измерениях.',
  },
  {
    id: 'sci-21',
    category: 'science',
    difficulty: 5,
    title: 'Фотосинтез',
    text: 'Растения превращают солнечный свет, воду и углекислый газ в глюкозу и кислород.',
  },
  {
    id: 'sci-22',
    category: 'science',
    ...
    text: 'Уравнения Максвелла объединили электричество и магнетизм в единую теорию электромагнитного поля.',
  },
  {
    id: 'sci-23',
    category: 'science',
    ...
    text: 'E=mc² — энергия равна массе, умноженной на квадрат скорости света. Масса и энергия эквивалентны.',
  },
  {
    id: 'sci-24',
    category: 'science',
    difficulty: 6,
    title: 'Геология — Тектоника плит',
    text: 'Литосферные плиты движутся со скоростью несколько сантиметров в год, формируя континенты.',
  },
  {
    id: 'sci-25',
    category: 'science',
    ...
    text: 'CRISPR-Cas9 позволяет точно редактировать ДНК, открывая новые возможности в медицине.',
  },
  {
    id: 'sci-26',
    category: 'science',
    difficulty: 5,
    title: 'Метеорология',
    text: 'Атмосферное давление, температура и влажность определяют погоду. Циклоны приносят дожди.',
  },
  {
    id: 'sci-27',
    category: 'science',
    difficulty: 7,
    title: 'Оптика',
    text: 'Свет преломляется, проходя через линзу. Фокусное расстояние определяет увеличение.',
  },
  {
    id: 'sci-28',
    category: 'science',
    difficulty: 6,
    title: 'Биохимия — Ферменты',
    text: 'Ферменты ускоряют химические реакции в организме в миллионы раз, не расходуясь.',
  },
  {
    id: 'sci-29',
    category: 'science',
    ...
    text: 'Ядерный синтез — процесс, питающий звёзды. На Земле его пытаются воспроизвести в токамаках.',
  },
  {
    id: 'sci-30',
    category: 'science',
    difficulty: 5,
    title: 'Экология — Пищевые цепи',
    text: 'Продуценты, консументы и редуценты образуют пищевую цепь экосистемы.',
  },
  {
    id: 'sci-31',
    category: 'science',
    difficulty: 7,
    title: 'Астрономия — Нейтронные звёзды',
    text: 'Нейтронная звезда весит как Солнце, но имеет диаметр всего 20 километров.',
  },
  {
    id: 'sci-32',
    category: 'science',
    difficulty: 6,
    title: 'Математика — Теория хаоса',
    text: 'Эффект бабочки: малое изменение в начальных условиях приводит к непредсказуемым результатам.',
  },
  {
    id: 'sci-33',
    category: 'science',
    ...
    text: 'Тёмная материя составляет 27% Вселенной, но не излучает свет и не взаимодействует с электромагнетизмом.',
  },
  {
    id: 'sci-34',
    category: 'science',
    difficulty: 6,
    title: 'Физиология — Кровеносная система',
    text: 'Сердце перекачивает около 5 литров крови в минуту, совершая 100 000 ударов в день.',
  },
  {
    id: 'sci-35',
    category: 'science',
    difficulty: 7,
    title: 'Эпигенетика',
    text: 'Эпигенетика изучает изменения экспрессии генов, не затрагивающие последовательность ДНК.',
  },
