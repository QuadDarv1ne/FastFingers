...
export type TranslationKey =
  ...
  | 'summary.levelUp' | 'summary.trainingComplete' | 'summary.keepItUp'
  | 'summary.errorsCount' | 'summary.minSec' | 'summary.xpEarned'
  | 'summary.toNextLevel' | 'summary.xpRemaining'
  | 'char.correct' | 'char.incorrect' | 'char.current' | 'char.pending' | 'char.space'
  | 'streak.rewards' | 'streak.dailyBonusDesc' | 'streak.currentStatus' | 'streak.bonus'
  | 'streak.toNextReward' | 'streak.allRewards' | 'streak.howItWorks' | 'streak.howItWorksDesc'
  | 'streak.bronze' | 'streak.silver' | 'streak.gold' | 'streak.diamond' | 'streak.royal' | 'streak.legendary'
  | 'insights.title' | 'insights.needMoreData' | 'insights.needMoreDataDesc'
  | 'insights.greatProgress' | 'insights.speedGrew' | 'insights.attention' | 'insights.speedDeclined'
  | 'insights.accuracyMaster' | 'insights.amazingAccuracy' | 'insights.workOnErrors' | 'insights.focusAccuracy'
  | 'insights.productiveTime' | 'insights.fasterIn' | 'insights.keepGoing' | 'insights.trainedToday'
  | 'insights.notTooLate' | 'insights.doOneSession' | 'insights.speedMode' | 'insights.yourRecord'
  | 'insights.perfectSession' | 'insights.had100Accuracy' | 'insights.timeOfDayTitle' | 'insights.bestTime'
  | 'insights.goalsProgress' | 'insights.dailyGoal' | 'insights.weeklyGoal'
  | 'insights.goalReached' | 'insights.weeklyGoalReached'
  | 'heatmap.key' | 'heatmap.presses' | 'heatmap.finger' | 'heatmap.mode' | 'heatmap.frequency'
  | 'heatmap.legendExcellent' | 'heatmap.legendGood' | 'heatmap.legendNeedsPractice'
  | 'heatmap.totalPresses' | 'heatmap.totalErrors' | 'heatmap.overallAccuracy' | 'heatmap.activeKeys' | 'heatmap.needsPractice'
  | 'finger.leftPinky' | 'finger.leftRing' | 'finger.leftMiddle' | 'finger.leftIndex'
  | 'finger.rightIndex' | 'finger.rightMiddle' | 'finger.rightRing' | 'finger.rightPinky' | 'finger.thumb'
  | 'leaderboard.subtitle' | 'leaderboard.loadError' | 'leaderboard.checkConnection'
  | 'leaderboard.noData' | 'leaderboard.noDataHint' | 'leaderboard.sortBy' | 'leaderboard.period'
