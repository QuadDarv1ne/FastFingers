...
describe('export utils', () => {
  const mockStats: TypingStats[] = [
    { wpm: 60, cpm: 300, accuracy: 95, errors: 5, timeElapsed: 60, correctChars: 300, totalChars: 315 },
    { wpm: 70, cpm: 350, accuracy: 98, errors: 2, timeElapsed: 60, correctChars: 350, totalChars: 357 },
  ]
